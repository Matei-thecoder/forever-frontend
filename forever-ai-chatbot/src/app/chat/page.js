  ...
  const handleSubmit = (e) => {
    ...
    if(convoid)
    {
        ...
        const next = [
            ...
            { role: "bot", content: "Loading…", loading: true },
        ];
        ...
        try {
            ...
            if (next[loadingIndex]?.loading) {
                next[loadingIndex] = { role: "bot", content: data.message };
            } else {
                next.push({ role: "bot", content: data.message });
            }
            return next;
            });
        } catch {
            ...
            if (next[loadingIndex]?.loading) {
                next[loadingIndex] = {
                    role: "bot",
                    content: " Eroare la preluarea răspunsului.",
                };
            }
            return next;
            });
